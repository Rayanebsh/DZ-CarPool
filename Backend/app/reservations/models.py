...
class Reservation(models.Model):
    ...
    def approve(self):
        ...
        if self.status != 'PENDING':
            raise ValueError("Seules les réservations en attente peuvent être approuvées")
    ...
    def cancel(self, reason=""):
        ...
        if self.status not in ['PENDING', 'CONFIRMED']:
            raise ValueError("Seules les réservations en attente ou confirmées peuvent être annulées")
