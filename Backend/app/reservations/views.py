...
from .serializers import ReservationSerializer, ReservationCreateSerializer, RatingSerializer
...
class ReservationViewSet(viewsets.ModelViewSet):
    ...
    queryset = Reservation.objects.select_related('trajet', 'passager', 'trajet__conducteur').all()
    ...
    def get_queryset(self):
        ...
        return self.queryset.filter(
            Q(passager=user) | Q(trajet__conducteur=user)
        )
