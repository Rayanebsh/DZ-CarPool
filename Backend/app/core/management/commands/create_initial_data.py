...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        preferences_data = [
            {'name': 'Musique', 'description': 'Aime écouter de la musique pendant le trajet'},
            ...
            {'name': 'Non-fumeur', 'description': 'Ne fume pas et n\'accepte pas les fumeurs'},
            {'name': 'Animaux acceptés', 'description': 'Accepte les animaux de compagnie'},
