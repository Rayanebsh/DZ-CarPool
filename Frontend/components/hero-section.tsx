    ...
    <section id="hero" className="relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="py-24 md:py-36 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 text-balance">{t("heroTitle")}</h1>
          <p className="text-lg md:text-xl text-white/90 mb-8 max-w-2xl mx-auto">{t("heroSubtitle")}</p>
