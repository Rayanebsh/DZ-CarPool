...
import { Search, CheckCircle, UsersIcon, Car, UserPlus, Wallet } from "lucide-react"
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-card rounded-2xl p-8 border border-border shadow-sm">
            <h3 className="text-2xl font-bold text-brand mb-8">{t("forPassengers")}</h3>
          ...
          {/* For Drivers */}
          <div className="bg-card rounded-2xl p-8 border border-border shadow-sm">
            <h3 className="text-2xl font-bold text-brand mb-8">{t("forDrivers")}</h3>
            <div className="space-y-6">
