              ...
              {langMenuOpen && (
                <div className="absolute right-0 mt-2 w-32 bg-background border border-border rounded-md shadow-lg overflow-hidden">
                  ...
                  <button
                    ...
                    className={`w-full px-4 py-2 text-left text-sm hover:bg-accent transition-colors ${
                      language === "fr" ? "bg-accent font-medium" : ""
                    }`}
                  >
                    Français
                  </button>
            ...
            <nav className="flex flex-col gap-4">
              ...
              <div className="border-t border-border pt-4 flex gap-2">
                ...
                <button
                  onClick={() => toggleLanguage("fr")}
                  className={`flex-1 px-3 py-2 text-sm rounded-md transition-colors ${
                    language === "fr" ? "bg-accent font-medium" : "hover:bg-accent"
                  }`}
                >
                  Français
                </button>
              ...
              <div className="flex flex-col gap-2 pt-2">
                ...
                <Link href="/signup">
                  <Button size="sm" className="bg-[#FF5722] hover:bg-[#FF5722]/90 text-white w-full">
                    {t("signup")}
                  </Button>
                </Link>
              </div>
