...
export default function ResetPasswordPage() {
  ...
  useEffect(() => {
    ...
    if (!tokenParam) {
      setError(language === 'en' ? 'Invalid or missing reset token' : 'Jeton de réinitialisation invalide ou manquant');
    } else {
      setToken(tokenParam);
    }
  ...
  const handleSubmit = async () => {
    ...
    if (!token) {
      setError(language === 'en' ? 'Invalid reset token' : 'Jeton de réinitialisation invalide');
      return;
    }
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            <h1 className="text-5xl font-bold text-gray-900 leading-tight">
              {language === 'en' ? 'Create New Password' : 'Créer un nouveau mot de passe'}
            </h1>
              ...
              <>
                <div>
                  <h2 className="text-2xl font-bold text-gray-900">
                    {language === 'en' ? 'Reset Your Password' : 'Réinitialisez votre mot de passe'}
                  </h2>
                ...
                <div className="space-y-4">
                  <div className="space-y-1.5">
                    ...
                    <p className="text-xs text-gray-500">
                      {language === 'en' ? 'Minimum 8 characters' : 'Minimum 8 caractères'}
                    </p>
                  </div>
                  ...
                  >
                    {loading 
                      ? (language === 'en' ? 'Resetting...' : 'Réinitialisation...') 
              ...
              <div className="text-center space-y-4 py-8">
                ...
                <div className="space-y-2">
                  <h3 className="text-xl font-bold text-gray-900">
                    {language === 'en' ? 'Password Reset Successful!' : 'Réinitialisation réussie !'}
                  </h3>
