  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Partagez vos trajets en covoiturage à travers l'Algérie. Économisez, voyagez éco et connectez-vous avec des conducteurs fiables." />
      </Head>
