          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                {language === "en" ? "Why Join DZ-CarPool?" : "Pourquoi rejoindre DZ-CarPool ?"}
              </h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">{language === "en" ? "Impact" : "Impact"}</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">{language === "en" ? "Team" : "Équipe"}</h3>
                <p className="text-sm text-gray-600">
                  {language === "en"
          ...
          <div className="container mx-auto px-4 lg:px-8">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap gap-3 text-sm text-gray-600">
                        <span className="flex items-center gap-1">
                          ...
                          {language === "en" ? job.department : job.departmentFr}
                        </span>
                        <span>•</span>
                        <span>{language === "en" ? job.location : job.locationFr}</span>
                        <span>•</span>
            ...
            <div className="text-center mt-12">
              ...
              <Button variant="outline" className="border-gray-300 bg-transparent">
                {language === "en" ? "Send us your resume" : "Envoyez-nous votre CV"}
              </Button>
            </div>
          </div>
        </section>
