...
"[project]/Desktop/Projet_GL/covoiturage/Frontend/components/ui/google-login-button.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function GoogleLoginButton({ className, children }) {
    ...
    const login = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projet_GL$2f$covoiturage$2f$Frontend$2f$node_modules$2f40$react$2d$oauth$2f$google$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGoogleLogin"])({
        onSuccess: {
            "GoogleLoginButton.useGoogleLogin[login]": async (tokenResponse)=>{
                setIsLoading(true);
                try {
                    // 1. Récupérer les informations du profil Google
                    const userInfoResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projet_GL$2f$covoiturage$2f$Frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('https://www.googleapis.com/oauth2/v3/userinfo', {
                        headers: {
                    ...
                    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projet_GL$2f$covoiturage$2f$Frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projet_GL$2f$covoiturage$2f$Frontend$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL || 'http://localhost:8000'}/api/users/google_auth/`, {
        ...
        onError: {
            "GoogleLoginButton.useGoogleLogin[login]": (error)=>{
...
_s(GoogleLoginButton, "GvbbWWiRpsLp596EEXLBa7dEohM=", false, function() {
    return [
...
"[project]/Desktop/Projet_GL/covoiturage/Frontend/app/signup/page.tsx [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
//# sourceMappingURL=Desktop_Projet_GL_covoiturage_Frontend_c1c1ba33._.js.map